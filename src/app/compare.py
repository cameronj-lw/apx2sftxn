...
def main():
    ...
    df1 = COREDBLWTxnSummaryTable().read(portfolio_code=args.portfolio_code, from_date=args.from_date, to_date=args.to_date)
    if args.from_date == datetime.date(2024, 4, 8):
        df2 = APXRepDBLWTxnSummaryTable().read(scenario='BASE', data_handle='8328CB5AC1CB40E083F0DA4EE0DAC2BD', portfolio_code=args.portfolio_code, from_date=args.from_date, to_date=args.to_date)
    else:
        df2 = APXRepDBLWTxnSummaryTable().read(scenario='BASE', data_handle='37020804B005458B874D74434DBCD0A0', portfolio_code=args.portfolio_code, from_date=args.from_date, to_date=args.to_date)
